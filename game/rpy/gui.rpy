...
## 游戏内文本使用的字体。
define gui.text_font = "Huayuan.Gothic.Bold.ttf"

## 角色名称使用的字体。
define gui.name_text_font = "Huayuan.Gothic.Bold.ttf"

## 游戏外文本使用的字体。
define gui.interface_text_font = "Huayuan.Gothic.Regular.ttf"

## 普通对话文本的大小。
define gui.text_size = 45
define gui.nvl_text_size = 70
...
define gui.confirm_text_size = 20
## 游戏标题的大小。
...
define gui.quick_button_text_font = "Huayuan.Gothic.Regular.ttf"
...
## 存档位按钮。
define gui.slot_button_width = 610
define gui.slot_button_height = 380
...
## 存档所用缩略图的宽度和高度。
define config.thumbnail_width = 533
...
## 对话文本的坐标、宽度和对齐方式。
define gui.history_text_xpos = 0.3
define gui.history_text_ypos = 0.0
define gui.history_text_width = 1007
define gui.history_text_xalign = 0.0
define gui.history_text_spacing = 15
